...
implements ActionListener {
	...
	public Main() {
		...
		// Host Icon
		ImageIcon hostIcon = createImageIcon("/images/icon/host.png");
        ...
        // Join Icon
        ImageIcon joinIcon = createImageIcon("/images/icon/join.png");
        ...
        // Play Icon
        ImageIcon playIcon = createImageIcon("/images/icon/play.png");
        
        // Play Filled Icon
        ImageIcon playFilledIcon = createImageIcon("/images/icon/playFilled.png");
	...
	public void actionPerformed(ActionEvent e) {
        if ("join".equals(e.getActionCommand())) {
            ...
            nameField.setActionCommand("launchClient");
            ...
            nameLabel.setVisible(true);
            nameField.setVisible(true);
            nameField.setActionCommand("launchBoth");
            nameField.addActionListener(this);
        	...
        	try {
        		if(!nameField.getText().equals("") && !IPAddressField.getText().equals("")) {
    ...
    private static void createAndShowGUI() {
        ...
        //Frame Icon
        ImageIcon icon = createImageIcon("/images/player/player.png");
