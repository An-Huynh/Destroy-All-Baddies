package dab.client.graphic.drawable.player;
...
public class PlayerDrawable implements VariableDrawable {
    ...
    protected void createProgram() throws IOException {
        ...
        String vSource = readSource("/resource/shader/player.vs");
        String fSource = readSource("/resource/shader/player.fs");
        ...
        if (fs.compileResult() == false) {
            System.out.println(fs.getLog());
        }
